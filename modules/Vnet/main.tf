...
resource "azurerm_subnet_network_security_group_association" "nsg_association_subnet_private_endpoint" {
    ...
    network_security_group_id = var.nsg_subnet_private_endpoint_id
...
resource "azurerm_subnet_network_security_group_association" "nsg_association_subnet_data_gateway" {
    ...
    network_security_group_id = var.nsg_subnet_data_gateway_id
...
# resource "azurerm_network_interface" "nic_data_gateway_vm_1" {
#     name = var.nic_data_gateway_vm_1_name
#     location = azurerm_resource_group.resource_group.location
#     resource_group_name = azurerm_resource_group.resource_group.name
...
# resource "azurerm_network_interface" "nic_data_gateway_vm_2" {
#     name = var.nic_data_gateway_vm_2_name
#     location = azurerm_resource_group.resource_group.location
#     resource_group_name = azurerm_resource_group.resource_group.name
...
# resource "azurerm_virtual_network" "virtual_network_adb" {
#     name = var.virtual_network_adb_name
#     location = azurerm_resource_group.resource_group.location
#     address_space = [ var.cidr_block_adb]
#     resource_group_name = azurerm_resource_group.resource_group.name
...
# resource "azurerm_subnet" "subnet_container_adb" {
#     name = var.subnet_container_adb_name
#     address_prefixes = [var.cidr_subnet_container_adb]
#     virtual_network_name = azurerm_virtual_network.virtual_network_adb.name
#     resource_group_name = azurerm_resource_group.resource_group.name   

#     delegation{
#         name = var.delegation_subnet_container_adb_name
#         service_delegation {
...
# resource "azurerm_subnet_network_security_group_association" "nsg_association_subnet_container_adb" {
#     subnet_id = azurerm_subnet.subnet_container_adb.id
#     network_security_group_id = var.nsg_subnet_container_adb_id
...
# resource "azurerm_subnet" "subnet_host_adb" {
#     name = var.subnet_host_adb_name
#     address_prefixes = [var.cidr_subnet_host_adb]
#     virtual_network_name = azurerm_virtual_network.virtual_network_adb.name
#     resource_group_name = azurerm_resource_group.resource_group.name   

#     delegation{
#         name = var.delegation_subnet_host_adb_name
#         service_delegation {
#           name = "Microsoft.Databricks/workspaces"
#           actions = [
#             "Microsoft.Network/virtualNetworks/subnets/join/action",
...
# resource "azurerm_subnet_network_security_group_association" "nsg_association_subnet_host_adb" {
#     subnet_id = azurerm_subnet.subnet_host_adb.id
#     network_security_group_id = var.nsg_subnet_host_adb_id
